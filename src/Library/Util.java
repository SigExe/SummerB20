...
public class Util {
    ...
    // reverse the string and find the value
    ...
    // find the frequency of char from str and returns as int
    ...
    // finds and returns the max number from int array
    ...
    // finds and returns the min number from int array
    ...
    public static Integer[]  sortDesc(Integer[] arr){
        ...
        for(Integer i = 0; i <= arr2.length-1; i++  ){
            arr2[i]  =  arr[k];
            k--;
        }
    ...
    public static Character[]  sortDesc(Character[] arr){
        ...
        int k = arr.length-1;
        for(Character i = 0; i <= arr2.length-1; i++  ){
            arr2[i]  =  arr[k];
            k--;
        }
